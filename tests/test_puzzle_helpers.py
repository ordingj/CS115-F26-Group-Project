...
class BathroomHelpersTest(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.bathroom = build_world()["bathroom"]
        self.state = GameState(current_room_id="bathroom")
...
class PuzzleHelpersTest(unittest.TestCase):
    ...
    def test_step1_clue_text_uses_template_and_opposite_direction(self) -> None:
        ...
        self.assertTrue(step1_is_correct("left", state))
        self.assertFalse(step1_is_correct("forward", state))
    ...
    def test_step3_roll_uses_direction_specific_song_pool(self) -> None:
        ...
        self.assertTrue(step3_is_correct("left", state))
        self.assertFalse(step3_is_correct("right", state))
